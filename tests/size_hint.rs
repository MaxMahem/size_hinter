...
mod ctor {
    ...
    ctor!(bounded_invalid, SizeHint::bounded(10, 5) => panic "size hint should be valid: InvalidSizeHint");
...
mod decrement {
    ...
    transform!(saturating_both, SizeHint::bounded(0, 0), decrement() == (0, Some(0)));
...
mod properties {
    ...
    transform!(size_hint, SizeHint::exact(7), size_hint() == (7, Some(7)));
...
mod is_subset_of {
    ...
    binary_op!(partial, is_subset_of, SizeHint::bounded(4, 6), SizeHint::bounded(3, 10) => true, false);
    binary_op!(invalid_lower_too_small, is_subset_of, SizeHint::bounded(2, 6), SizeHint::bounded(3, 10) => false, false);
    binary_op!(invalid_upper_too_large, is_subset_of, SizeHint::bounded(4, 11), SizeHint::bounded(3, 10) => false, false);
    binary_op!(equal, is_subset_of, SizeHint::bounded(5, 10), SizeHint::bounded(5, 10) => true, true);
    binary_op!(bounded_in_unbounded, is_subset_of, SizeHint::bounded(5, 10), SizeHint::unbounded(3) => true, false);
    binary_op!(unbounded_not_in_bounded, is_subset_of, SizeHint::unbounded(5), SizeHint::bounded(3, 10) => false, false);
}
