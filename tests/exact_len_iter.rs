...
initial_state!(len_too_small, TEST_ITER.exact_len(2), panic: "Invalid length: len (2) must be within wrapped iterator's size hint bounds");
initial_state!(len_too_large, TEST_ITER.exact_len(6), panic: "Invalid length: len (6) must be within wrapped iterator's size hint bounds");
